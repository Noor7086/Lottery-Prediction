  ...
  const lotteryTypes = [
    {
      ...
      features: ["5 white balls + Powerball", "Twice weekly draws", "Multi-state participation"]
    },
    {
      name: "Mega Millions",
    ...
    },
    {
      ...
      features: ["5 white balls + Star Ball", "Weekly draws", "Multi-state game"]
    },
    {
      name: "Gopher 5",
      description: "Minnesota's state lottery with daily draws",
      features: ["5 numbers from 1-47", "Daily draws", "State-specific game"]
    },
    {
      name: "Pick 3",
